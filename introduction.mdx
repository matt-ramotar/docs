---
title: Meet Meeseeks
description: Meeseeks is a Kotlin Multiplatform library for scheduling and managing background tasks across Android, iOS, web, and desktop. Whether your tasks are simple or complex, for one user or hundreds of millions, Meeseeks can help.
...
<Card title="Reliability" icon="shield-check" iconType="duotone">
  ...
  on iOS, and robust concurrency for other platforms. Even if the app closes or
  the device restarts, your tasks persist.
</Card>
